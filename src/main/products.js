  ...
  return (
    <section id='produtos' className='bg-qua font-roboto py-[20px]'>
      <article className={`${PADDING} flex flex-col text-center gap-[20px] relative overflow-hidden`}>
        ...
        <div className='sm:gap-[20px] sm:grid sm:grid-cols-2 lg:grid-cols-3'>
          {produtos.map((prod, index) => {
            ...
            return (
              <div style={{
                ...
                key={index} className={`flex flex-col bg-[#f0f7fa] rounded py-[20px] transition-transform duration-1000 ease-in-out transform hover:scale-105 ${index == 2 && 'mb-[50px]'} lg:mb-[50px] gap-[20px]`}>
